...
**Estimated cost:** Low - verify Preview status per bullet before writing
**Licensing required:** Microsoft Entra ID P2; Copilot Studio capacity
...
**Portal path:** Entra admin center > Agent ID; Defender portal; M365 admin center

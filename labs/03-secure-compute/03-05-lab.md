...
**Estimated cost:** Medium-HIGH - AKS node pool bills continuously; tear down same day
**Licensing required:** Defender for Containers plan
...
**Portal path:** Azure portal > Kubernetes services / Container registries

<!-- Numbered steps. One action per step. -->

## Method B - PowerShell

**Modules:** Az.Aks, Az.ContainerRegistry

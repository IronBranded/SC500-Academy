...
**Estimated cost:** Low if ingestion is kept minimal
...
**Portal path:** Defender portal > Microsoft Sentinel

<!-- Numbered steps. One action per step. -->

## Method B - PowerShell

**Modules:** Az.OperationalInsights, Az.SecurityInsights
...
```powershell
.\scripts\teardown\Remove-LabResourceGroup.ps1 -LabId '04-02' -WhatIf
```
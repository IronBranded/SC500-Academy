...
**Estimated cost:** Low
**Licensing required:** Sentinel; Purview Audit (Standard/Premium)
...
**Portal path:** Defender portal > Sentinel > Automation; Purview portal > Audit

<!-- Numbered steps. One action per step. -->

## Method B - PowerShell

**Modules:** Az.SecurityInsights, Az.LogicApp
